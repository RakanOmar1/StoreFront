...
export const appRoutes: Routes = [
  ...
  { path: 'admin/brands', pathMatch: 'full', component: AdminTablePageComponent, canActivate: [AuthGuard, AdminGuard], data: { tableType: 'brands' } },
  { path: 'admin/brands/new', component: AdminCrudPageComponent, canActivate: [AuthGuard, AdminGuard], canDeactivate: [UnsavedChangesGuard], data: { entity: 'brands', mode: 'create' } },
  { path: 'admin/brands/:id', component: AdminCrudPageComponent, canActivate: [AuthGuard, AdminGuard], data: { entity: 'brands', mode: 'view' } },
  { path: 'admin/brands/:id/edit', component: AdminCrudPageComponent, canActivate: [AuthGuard, AdminGuard], canDeactivate: [UnsavedChangesGuard], data: { entity: 'brands', mode: 'edit' } },
  { path: 'admin/brands/:id/delete', component: AdminCrudPageComponent, canActivate: [AuthGuard, AdminGuard], data: { entity: 'brands', mode: 'delete' } },
